public class CapitalizationFilter extends TextReaderDecorator {
    String [] words;
    String finalString = "";
    public CapitalizationFilter(TextReaderInterface rInterface) {
        super(rInterface);
    }
    ...
    public String next() {
        ...
        int idx = 0;
        String newLastWord = "";
        while (isAlpha(String.valueOf(lastWord.charAt(idx)))) {
            newLastWord = newLastWord + Character.toLowerCase((lastWord.charAt(idx)));
            idx++;
        }
